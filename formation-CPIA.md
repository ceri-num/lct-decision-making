...
- Identifier dans votre cadre professionnel une problématique de prise de décision séquentiel.

Plus de détail sur la page de [q-learning](./game421/q-learning.md).

## Appréhender un système plus complexe

La difficulté ensuite consiste à d'apréhender des systéme plus complexe.

Le jeu Zombie Dice par exemple est un autre jeux de dés de type "stop" and "go" ou l'évolution du jeux dépend de dés pris pris dans une réserve de dés. Il y a donc une double combinatoire sur le lancer de dés et sur leur sélections. 
