...
These pages serve as support for the lecture of _D2U2_ apparing in differents module:

- UV Model Agent Decision - **uv-mad**
- Artificial Intelligence and Combinatorial Optimization (Introcduction & Project) - **P-AICO-I**
- FC Manager IA

You will find there mostly presentation of the core notions.
The tutorials are mostly based on [HackaGames](https://ktorz-net.github.io/hackagames)
...
The _markdown > marp: themes_ setting parameter of the workspace should be set with : `style/imt-slide.css`
